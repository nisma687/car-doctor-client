...
const Banner = () => {
    return (
        <div className="carousel w-full h-[600px] mb-4">
          ...
          className="absolute flex 
            ...
            <div className="space-y-7
             text-white pl-4  ">
                ...
                <h2 className="text-6xl font-bold lg:w-1/2 ">Affordable Price For Car Servicing</h2>
                <p 
                className="mt-2 text-2xl lg:w-1/2 ">
                There are many variations of passages of  available, but the majority have suffered alteration in some form
                </p>
              <div>
              <button className="btn btn-active btn-primary mr-4">Discover More</button>   
                <button 
                className="btn btn-outline btn-secondary">Latest Project</button>
              </div>
            </div>
          </div>
